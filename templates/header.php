...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="vendor/files/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="vendor/files/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="vendor/files/aos/aos.css" rel="stylesheet">
  <link href="vendor/files/remixicon/remixicon.css" rel="stylesheet">
  <link href="vendor/files/swiper/swiper-bundle.min.css" rel="stylesheet">
  <link href="vendor/files/glightbox/css/glightbox.min.css" rel="stylesheet">
  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="" class="logo d-flex align-items-center">
        <img src="vendor/img/attack.jpg" alt="">
        <span>Covid Monitoring</span>
      </a>
